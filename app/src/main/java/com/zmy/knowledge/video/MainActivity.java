package com.zmy.knowledge.video;
                    ...
                    if (!TextUtils.isEmpty(mime_type) && mime_type.contains("video") && !TextUtils.isEmpty(_data)) {
                        ...
                        new Thread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                File file2 = new File(onlyCompressOverBean.getVideoPath());
                                Log.e("压缩", "压缩后大小= " + file2.length()+"\n 路径="+file2.getAbsolutePath());
                                okTime = System.currentTimeMillis();
                                Log.e("压缩", "耗时=" + ((okTime - startTime) / 1000) + "s");
